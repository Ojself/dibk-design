import{j as d,L as p}from"./iframe-C-jjyl2S.js";import{B as m}from"./Button-DweBpD6F.js";import"./preload-helper-PPVm8Dsz.js";const h={title:"Example/Button",component:m,tags:["autodocs"]},t={args:{color:"primary",content:"Button",size:"regular",arrow:"none"}},n={args:{color:"secondary",content:"Button"}},e={args:{size:"small",content:"Button"}},r={args:{rounded:!0,content:"Button"}},o={args:{children:d.jsxs("span",{children:["Button with ",d.jsx("b",{children:"HTML"})," content"]})}},a={args:{content:"Button with link",href:"test"}},s={args:{children:d.jsx(p,{to:"/test",children:"Button with React Link"})}},c={args:{disabled:!0,children:d.jsx(p,{to:"/test",children:"Disabled button with React Link"})}},u={args:{content:"InputButton",inputType:"button"}},i={args:{content:"RadioButton",inputType:"radio",name:"radio-button",defaultChecked:!1}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    content: 'Button',
    size: 'regular',
