...
WithContentOnlyAndKeyAsContent.args = {
  id: 'select11',
  label:
    'Select with label, selected value, contentOnly set to true and keyAsContent set to true',
  value: 'value 3',
  contentOnly: true,
  keyAsContent: true,
  options,
...
WithContentOnlyAndDefaultContent.args = {
  id: 'select12',
  label:
    'Select with label, contentOnly set to true, no value and defaultContent',
  contentOnly: true,
