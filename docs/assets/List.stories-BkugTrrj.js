import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{L,a as r}from"./ListItem-CMUoTpfG.js";import{T as O}from"./ThemeProvider-Dl0m7e08.js";import"./iframe-CzTDeAL5.js";const R={title:"Example/List",component:L,argTypes:{},tags:["autodocs"],decorators:[(f,q)=>{const{theme:W,...E}=q.args;return e.jsx(O,{theme:W,children:e.jsx(f,{args:E})})}]},d=e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"item 1"}),e.jsx(r,{children:"item 2"}),e.jsx(r,{children:"item 3"})]}),T=e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"item 1"}),e.jsxs(r,{children:["item 2",e.jsxs(L,{children:[e.jsx(r,{children:"subitem 1"}),e.jsx(r,{children:"subitem 2"})]})]}),e.jsx(r,{children:"item 3"})]}),s={args:{children:d,ordered:!0}},t={args:{children:d}},n={args:{children:d,listStyle:"square"}},a={args:{children:d,listStyle:"none"}},o={args:{children:T}};var i,c,m;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    children: listItems,
    ordered: true
  }
